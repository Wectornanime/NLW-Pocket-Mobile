...
import { Categories, CategoriesProp } from "@/components/categories";
...
export default function Home() {
  ...
  async function fetchCategories() {
    try {
      ...
      console.log(error)
      Alert.alert('Categorias', 'Não  foi possível encontrar as categorias')
    }
  }
  ...
  async function fetchMarkets() {
    try {
      ...
      console.log(error)
      Alert.alert('Markets', 'Não  foi possível encontrar os locais')
    }
  }
