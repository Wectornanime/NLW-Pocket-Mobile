...
export default function Market() {
  ...
  async function handleOpenCamera() {
    try {
      ...
      if(!granted) {
        return Alert.alert('Câmera', 'Você precisa de habilitar o uso da câmera.')
      }
  ...
  function handleUseCoupon(id: string) {
    ...
    Alert.alert('Cupom', 'Não é possível reutilizar um cupom regatado. Deseja realmente resgatar o cupom?', [
